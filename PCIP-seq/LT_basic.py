...
def fun_invert_dnaseq(seq):
    ...
    d = {"A":"T","T":"A","G":"C","C":"G","a":"t","t":"a","g":"c","c":"g"}
    cseq=""
...
def fun_print_help(*args):
    """print a simple help info. eg:fun_print_help("a.bed", "b.bed")"""
    fun_print("usage:","green","black",1)
    str_args=" ".join(args)
...
def fun_print_error(error):
    ...
    sys.stderr.write("\033[1;31;47m{0}\033[0m\n".format(error))
    sys.exit(0)

def fun_print(content,col="white",bg="black",font=0):
    """
    ...
    dict_bg={"white":47,"black":40,"red":41,"green":42,\
        "brown":43,"blue":44,"purple":45,"cyan":46}
    ...
    print("\033[{};{};{}m{}\033[0m".format(font_style,col_style,bg_style,content))
...
def fun_open_file(path,action="r"):
    ...
    try:
        ...
        fun_print_error("No file in {}".format(path))

def fun_read(path,format="tab",type="list",key_number=1,sep="\t"):
    """
    read file into list or dict.
    usage:
    fun_read(path,format="tab|bed|chrom_size",type="list/l|dict/d", key_number=1|[0-9]+,seq="\\t|...")
    ...
    if type=="list" or type=="l":
        ...
        for l in file_in:
            ...
            try:
                ...
                fun_print_error("the column number is less than {}, \
        ...
        fun_print_error("wrong type: {}. only support list/l and dict/d".format(type))
    file_in.close()
    return out
